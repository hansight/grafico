...
function (angular,$) {
  ...
  angular
    ...
    .directive('kibanaPanel', function($compile, $rootScope) {
      ...
      var panelHeader =
      '<div class="panel-header" ng-style="{ display: panel.hiddenHeader? \'none\' : \'block\' }">'+
        '<div class="row-fluid">' +
        ...
        '<div class="row-fluid panel-extra">' +
          '<div class="panel-extra-container">' +
            ...
            '<span class="extra row-button " ng-show="panel.editable != false">' +
              '<span class="pointer" bs-tooltip="\'Drag here to move\'"><i class="icon-move gs-draggable"></i></span>'+
            '</span>' +

            '<span class="row-button extra" ng-show="panel.editable != false">' +
              '<span config-modal="./app/partials/panel-editor.html" kbn-model="panel" class="pointer">'+
              '<i class="icon-cog pointer" bs-tooltip="\'Configure\'"></i></span>'+
            '</span>' +

            '<span class="row-button extra" ng-show="panel.editable != false">' +
              '<span class="dropdown">'+
                '<a href="#" bs-tooltip="\'Change Type\'" data-placement="bottom" class="dropdown-toggle" data-toggle="dropdown">'+
